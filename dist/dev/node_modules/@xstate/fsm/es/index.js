...
function f(t2, n, e2) {
  ...
  return [t2.filter(function(t3) {
    if ("xstate.assign" === t3.type) {
      ...
      return "function" == typeof t3.assignment ? n2 = t3.assignment(r2, e2) : Object.keys(t3.assignment).forEach(function(i2) {
        n2[i2] = "function" == typeof t3.assignment[i2] ? t3.assignment[i2](r2, e2) : t3.assignment[i2];
      }), r2 = n2, false;
    }
    return true;
  }), r2, i];
...
function s(n, i) {
  ...
  }), n.context, e), 2), l2 = s2[0], v2 = s2[1], y = { config: n, _options: i, initialState: { value: n.initial, actions: l2, context: v2, matches: a(n.initial) }, transition: function(e2, i2) {
    var s3, l3, v3 = "string" == typeof e2 ? { value: e2, context: n.context } : e2, p = v3.value, g = v3.context, d = u(i2), x = n.states[p];
    if (x.on) {
      var m = r(x.on[d.type]);
      try {
...
function v(t2) {
  var r2 = t2.initialState, i = exports.InterpreterStatus.NotStarted, o2 = /* @__PURE__ */ new Set(), c2 = { _machine: t2, send: function(e2) {
    i === exports.InterpreterStatus.Running && (r2 = t2.transition(r2, e2), l(r2, u(e2)), o2.forEach(function(t3) {
      return t3(r2);
    }));
    ...
    if (o3) {
      ...
      r2 = t2.initialState;
    return i = exports.InterpreterStatus.Running, l(r2, e), c2;
  }, stop: function() {
    return i = exports.InterpreterStatus.Stopped, o2.clear(), c2;
  }, get state() {
    return r2;
  }, get status() {
    return i;
